...
victim='10.0.2.2'    		 #This is the IP address of interface through which the victim will receive the trigger LSA. 
victimId='10.0.2.2'		     #This the router ID of the victim router.
victimNeighbor='10.0.2.1'	 #This is the IP address of a neighbor of the victim router to which the disguised LSA is sent
spoofSRC='192.168.31.4'			 #This is an IP address of one of the neighbors of the victim. It is used as a spoofed IP source. 
host1='10.0.2.4'		 #This will used in the bogus Link entries in the disguised LSA.
host2='10.0.2.5'		 #This will used in the bogus Link entries in the disguised LSA.
